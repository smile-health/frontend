...
import ManufactureTable from './components/ManufactureTable';
        ...
        <div className="ui-space-y-6 ui-my-5 ui-rounded">
          ...
          <PaginationContainer>
            <PaginationSelectLimit
              ...
              perPagesOptions={manufactureDataSource?.list_pagination}
            />
            <PaginationInfo
              size={pagination.paginate}
              currentPage={pagination.page}
              total={manufactureDataSource?.data.pagination.total}
            />
            <Pagination
              totalPages={manufactureDataSource?.data.pagination.pages ?? 0}
              currentPage={pagination.page}
